...
public class SignFlowDetailResponse {
    ...
    public static class NoticeConfig {
        private String noticeTypes; // 通知类型
    }
    ...
    public static class AuthConfig {
        private List<String> psnAvailableAuthModes; // 个人实名认证方式可选项
        private List<String> orgAvailableAuthModes; // 机构实名认证方式可选项
        private List<String> willingnessAuthModes; // 签署意愿认证方式可选项
    }
